...
describe User do
  it { should validate_presenece_of(:email) }
  it { should validate_presenece_of(:password) }
  it { should validate_presenece_of(:full_name) }
  ...
  describe "#queued_video?" do
    ...
    it "returns false when the suer hasn't queued the video" do
      user = Fabricate(:user)
      video = Fabricate(:video)
